...
function benchmark_recursive()
    ...
    for (i, mesh) in enumerate(meshes)
        ...
        if draw
          save("images/recursive/$(mesh)_coordinate_recursive08.pdf",
               draw_graph(A, coords, pCoordinate08));
          save("images/recursive/$(mesh)_coordinate_recursive16.pdf",
               draw_graph(A, coords, pCoordinate16));
        end
        ...
        if draw
          save("images/recursive/$(mesh)_metis_kway08.pdf",
               draw_graph(A, coords, pMetis_kway08));
          save("images/recursive/$(mesh)_metis_kway16.pdf",
               draw_graph(A, coords, pMetis_kway16));
        end
        ...
        if draw
          save("images/recursive/$(mesh)_metis_recursive08.pdf",
               draw_graph(A, coords, pMetis_recursive08));
          save("images/recursive/$(mesh)_metis_recursive16.pdf",
               draw_graph(A, coords, pMetis_recursive16));
        end
        ...
        if draw
          save("images/recursive/$(mesh)_inertial_recursive08.pdf",
               draw_graph(A, coords, pInertial08));
          save("images/recursive/$(mesh)_inertial_recursive16.pdf",
               draw_graph(A, coords, pInertial16));
        end
        ...
        if draw
          save("images/recursive/$(mesh)_spectral_recursive08.pdf",
               draw_graph(A, coords, pSpectral08));
          save("images/recursive/$(mesh)_spectral_recursive16.pdf",
               draw_graph(A, coords, pSpectral16));
        end
